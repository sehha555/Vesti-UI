...
import { motion } from 'motion/react';
import { Camera, User, Ruler, Settings, Upload, Edit2, Check, X, Package, ChevronRight, Sparkles, Search, Plus, ShoppingBag, Blend, Star, ShoppingCart, LogOut } from 'lucide-react';
import { ImageWithFallback } from './figma/ImageWithFallback';
import { toast } from 'sonner@2.0.3';
...
export function ProfilePage({ onNavigateToCheckout, onLogout }: ProfilePageProps = {}) {
>>>>>>> de3ed00c33a5d0df6cf810802fd173e4ca4388a2
...
=======
                <div className="flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-[var(--vesti-primary)]/10 to-[var(--vesti-primary)]/5 border-2 border-dashed border-[var(--vesti-primary)]/30">
                  <User className="h-8 w-8 text-[var(--vesti-primary)]/40" strokeWidth={1.5} />
                </div>
              )}
              <label
                htmlFor="profile-photo-upload"
                className="absolute bottom-0 right-0 flex h-7 w-7 cursor-pointer items-center justify-center rounded-full bg-[var(--vesti-primary)] text-white shadow-lg transition-all hover:bg-[var(--vesti-primary)]/90"
              >
                <Camera className="h-4 w-4" strokeWidth={2} />
                <input
...
<<<<<<< HEAD
            ...
            >
=======
            <div className="relative rounded-xl overflow-hidden bg-[var(--vesti-gray-light)]">
>>>>>>> de3ed00c33a5d0df6cf810802fd173e4ca4388a2
              <ImageWithFallback
                src={tryOnPhoto}
                alt="Try On Photo"
...
=======
              <label
                ...
                className="absolute bottom-3 right-3 flex h-10 w-10 cursor-pointer items-center justify-center rounded-full bg-[var(--vesti-primary)] text-white shadow-lg transition-all hover:bg-[var(--vesti-primary)]/90"
              >
                <Camera className="h-5 w-5" strokeWidth={2} />
                <input
            ...
            <label
              htmlFor="tryon-photo-upload-initial"
              className="flex cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-[var(--vesti-primary)]/30 bg-gradient-to-br from-[var(--vesti-primary)]/5 to-[var(--vesti-primary)]/10 py-8 transition-all hover:border-[var(--vesti-primary)]/50"
>>>>>>> de3ed00c33a5d0df6cf810802fd173e4ca4388a2
            >
...
<<<<<<< HEAD
            ...
            >
=======
            <button className="flex items-center gap-1 text-[var(--vesti-primary)]" style={{ fontSize: 'var(--text-label)' }}>
>>>>>>> de3ed00c33a5d0df6cf810802fd173e4ca4388a2
              <span>查看全部</span>
